            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        ...
                        Tổng số: <span class="fw-semibold text-dark">{{ $thongbaos->count() }}</span> thông báo
                    </p>
                </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="px-4 py-3">
                                <i class="fas fa-flag text-primary me-2"></i>Mức độ
                            </th>
                            <th class="px-4 py-3">
                    ...
                    <tbody>
                        ...
                        <tr class="border-bottom">
                            ...
                            <td class="px-4 py-3">
                                @php
                                    $badgeClass = match($tb->DoiTuongNhan) {
                                        'SinhVien' => 'primary',
                                        'GiangVien' => 'success',
                                        'TatCa' => 'secondary',
                                        default => 'secondary'
                                    };
                                    $badgeText = match($tb->DoiTuongNhan) {
                                        'SinhVien' => 'Sinh viên',
                            ...
                            <td class="px-4 py-3">
                                ...
                                @endphp
                                <span class="badge bg-{{ $mucDoClass }} px-3 py-2">{{ $tb->MucDo ?? 'Bình thường' }}</span>
                            </td>
                            <td class="px-4 py-3">
                                <small class="text-muted">
                                    <i class="far fa-calendar-alt me-1"></i>
                                    {{ $tb->TGDang ? \Carbon\Carbon::parse($tb->TGDang)->format('d/m/Y H:i') : 'N/A' }}
                                </small>
                            </td>
                            <td class="px-4 py-3">
                                @if($tb->TenFile)
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="btn-group" role="group">
                                    ...
                                    <form id="deleteForm{{ $tb->MaTB }}" action="{{ route('canbo.thongbao.destroy', $tb->MaTB) }}"
                                          method="POST"
...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <form action="{{ route('canbo.thongbao.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="MucDo" class="form-select shadow-sm" required>
                                ...
                                <option value="Quan trọng">⚠️ Quan trọng</option>
                                <option value="Bình thường" selected>ℹ️ Bình thường</option>
                            </select>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    editButtons.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            // Reset form action
            editForm.action = `/canbo/thongbao/${id}`;
